...
- Authentication and user management through Auth - Multi-tenant workspaces using Auth Organizations (create, switch, manage teams)
- Billing and subscriptions via Auth Billing for B2B, with plan management and feature gating
...
| Page                                                                                                                                                                  | Notes                                                                                                                                                                                |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Signup / Signin](https://go.                                                                                                                       | Auth handled by Clerk, with passwordless sign-in, social logins, and enterprise SSO.                                                                                                |
...
| [Profile](https://shadcn-dashboard.kiranism.dev/dashboard/profile)                                                                                                   | Auth s account management UI for profile and security settings.                                                                                                                    |
...
| [Workspaces](https://shadcn-dashboard.kiranism.dev/dashboard/workspaces)                                                                                              | Organization management using Auth s `<OrganizationList />`. View, create, and switch between organizations.                                                                       |
| [Team Management](https://shadcn-dashboard.kiranism.dev/dashboard/workspaces/team)                                                                                    | Team management using Auth s `<OrganizationProfile />`. Manage members, roles, permissions, security, and org details. Needs an active organization.                               |
| [Billing & Plans](https://shadcn-dashboard.kiranism.dev/dashboard/billing)                                                                                            | Billing page using Auth s `<PricingTable />`. View plans, subscribe, and manage subscriptions. Needs an active organization.                                                       |
| [Exclusive Page](https://shadcn-dashboard.kiranism.dev/dashboard/exclusive)                                                                                           | Plan-based access control with Auth s `<Protect>`. Only available to organizations on the Pro plan, with a fallback UI for everyone else.                                          |
...
For setting up Auth auth (including organizations, workspaces, and teams), see [clerk_setup.md](./docs/clerk_setup.md).
